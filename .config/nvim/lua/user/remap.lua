...
-- Skeletons
vim.keymap.set("n", ",html", ":-1read $HOME/.config/nvim/skeletons/skeleton.html<CR>6jwf>a")
vim.keymap.set("n", ",py", ":-1read $HOME/.config/nvim/skeletons/skeleton.py<CR>jA")
vim.keymap.set("n", ",cpp", ":-1read $HOME/.config/nvim/skeletons/skeleton.cpp<CR>3jA")

--Enable/Disable TreeSitter highlight
vim.keymap.set("n", "<leader>te", ":TSEnable highlight<CR>")
vim.keymap.set("v", "<leader>te", ":TSEnable highlight<CR>")
vim.keymap.set("n", "<leader>td", ":TSDisable highlight<CR>")
vim.keymap.set("v", "<leader>td", ":TSDisable highlight<CR>")
